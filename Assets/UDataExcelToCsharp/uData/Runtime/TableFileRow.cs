...
namespace uData
{
    ...
    public partial class TableFileRow : TableRowFieldParser
    {
		...
		/// <summary>
		/// Initializes a new instance of the <see cref="T:uData.TableFileRow"/> class.
		/// </summary>
        ...
        public virtual object Get(int index)
        {
            ...
            {
                Debug.LogError(string.Format("Overflow index `{0}`", index));
            }
        ...
        public string this[string headerName]
        {
            get
            {
                ...
                {
                    Debug.LogError("not found header: " + headerName);
                }

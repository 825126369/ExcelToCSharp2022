...
namespace TableML.Compiler
{
    ...
    public class Compiler
    {
		...
		public TableCompileResult Compile(string path)
		{
			...
			return Compile(path, outputPath,string.Empty);
		}
        ...
        /// <returns></returns>
        public TableCompileResult Compile(string path, string compileToFilePath,string codePath, string compileBaseDir = null, bool doRealCompile = true)
        {
			// 确保目录存在
